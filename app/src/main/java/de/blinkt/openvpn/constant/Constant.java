...
//	public static final String TARGET_ID = "";
	 ...
	 * 乐视手机
	 */
	public static final String LETVPACKAGENAME_APPPROTECTOR = "com.letv.android.letvsafe";
	public static final String LETVPACKAGE_APPPROTECTOR = "com.letv.android.letvsafe.AutobootManageActivity";
	public static final String LETVPACKAGENAME_AUTORUN = "com.letv.android.letvsafe";
	public static final String LETVPACKAGE_AUTORUN = "com.letv.android.letvsafe.BackgroundAppManageActivity";

	/**
	 * 魅族手机
	 */
	public static final String MEIZU_PACKAGENAME_KEEPSTAND = "com.meizu.safe";
	public static final String MEIZU_PACKAGE_KEEPSTAND = "com.meizu.safe.SecurityCenterActivity";

	/**
	 * 小米
	 */
	public static final String XIAOMI_PACKAGENAME_KEEPSTAND = "com.miui.powerkeeper";
	public static final String XIAOMI_PACKAGE_KEEPSTAND = "com.miui.powerkeeper.ui.HiddenAppsContainerManagementActivity";
	/**
	 * GIONEE
	 */
	public static final String GIONEE_PACKAGENAME_AUTORUN = "com.gionee.softmanager";
	public static final String GIONEE_PACKAGE_AUTORUN = "com.gionee.softmanager.MainActivity";

	/**
	 * VIVO
	 */
	public static final String VIVO_PACKAGENAME_HIGHPOWER = "com.vivo.abe";
	public static final String VIVO_PACKAGE_HIGHPOWER = "com.vivo.applicationbehaviorengine.ui.ExcessivePowerManagerActivity";

	/**
	 * HUAWEI
	 */
	public static final String HUAWEI_PACKAGENAME_LOCKSCREEN = "com.huawei.systemmanager";
	public static final String HUAWEI_PACKAGE_LOCKSCREEN = "com.huawei.systemmanager.optimize.process.ProtectActivity";

	public static final String HUAWEI_PACKAGE_AUTORUN = "huawei.intent.action.HSM_BOOTAPP_MANAGER";

	/**
	 * oppo
	 */
	public static final String OPPO_PACKAGENAME_SHUTDOWN = "com.coloros.oppoguardelf";
	public static final String OPPO_PACKAGE_SHUTDOWN = "com.coloros.powermanager.fuelgaue.PowerConsumptionActivity";

	public static final String OPPO_PACKAGENAME_OPENSYSTEMSUSPEND = "com.coloros.safecenter";
	public static final String OPPO_PACKAGE_OPENSYSTEMSUSPEND = "com.coloros.safecenter.sysfloatwindow.FloatWindowListActivity";

	public static final String OPPO_PACKAGENAME_AUTORUN_KITKAT = "com.color.safecenter";
	public static final String OPPO_PACKAGE_AUTORUN_KITKAT = "com.color.safecenter.permission.startup.StartupAppListActivity";
