...
public class SMSAcivity extends BaseNetActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Object object = getIntent().getSerializableExtra(IntentPutKeyConstant.SMS_LIST_KEY);//从有号码的地方进入发短信界面
        receivePhoneNumer = getIntent().getStringExtra(IntentPutKeyConstant.RECEIVE_SMS);//从通知进来
        if (object != null) {
