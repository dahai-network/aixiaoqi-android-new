...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
	...
	private ICSOpenVPNApplication application;
	//用来存储设备信息和异常信息
	 ...
	 * @param context
	 */
	public void init(Context context, ICSOpenVPNApplication application) {
		mContext = context;
...
//					restartIntent); // 1秒钟后重启应用
	...
	private String saveCrashInfo2File(Throwable ex) {
		...
		Set<Map.Entry<String, String>> localSet = infos.entrySet();
