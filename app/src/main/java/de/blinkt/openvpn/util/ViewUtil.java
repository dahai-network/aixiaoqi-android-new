...
public class ViewUtil {
	 ...
	 */
	public static void showTextHighlight(TextView tv, String baseText, String highlightText, String highlightcolor) {
		 ...
		 */
		Spanned spanned = Html.fromHtml(baseText.substring(0, index) + "<font color=" + highlightcolor + " >"
